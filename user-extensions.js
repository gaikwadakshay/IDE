...
Selenium.prototype.doPrintMyName = function(paramString){
    alert("My name is " +paramString.toString());
    LOG.info("Name Printed ");
};

Selenium.prototype.doGenerateRandomNumber = function(randomNo){

    storedVars[ randomNo ] = Math.random();
